...
export default function BookPage() {
  ...
  return (
    ...
    >
      ...
      >
        <div className={styles.leftIcons}></div>
    ...
    <span className="center small">${selectedBook[0].author} </span>
    ${selectedBook[0].content.german}
        <h1 className="center">English </h1>

    ${selectedBook[0].content.english}
        <h1 className="center">Arabic</h1>

<div dir="rtl">
      ${selectedBook[0].content.arabic}
    </div>
    </aside>
        </main>
        `}
